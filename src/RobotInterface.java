...
public abstract class RobotInterface {
	...
	{
		//for the purpose of this function only, to input the instructions into the stack
	...
	//input the direction of checking and return true if robot can move that direction
